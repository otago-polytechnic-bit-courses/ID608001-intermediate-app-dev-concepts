...
Open your repository in **Visual Studio Code**. Create a new branch called **week-02-typescript-react-2**.
...
- Project name: **week-02-typescript-react-2**
- Framework: **React**
