...
Link to the previous class: [Week 02](https://github.com/otago-polytechnic-bit-courses/ID608001-intermediate-app-dev-concepts/tree/s2-25/lecture-notes/web-development-stream/02-typescript-react-2.md)

---

## Before We Start

Open your repository in **Visual Studio Code**. Create a new branch called **week-03-state-management**.
...
- Project name: **week-03-state-management**
- Framework: **React**
...
Link to the next class: [Week 04](https://github.com/otago-polytechnic-bit-courses/ID608001-intermediate-app-dev-concepts/tree/s2-25/lecture-notes/web-development-stream/04-react-query-tanstack-query-react-hook-form.md)
