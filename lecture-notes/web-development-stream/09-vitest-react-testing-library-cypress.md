...
Open your repository in **Visual Studio Code**. Create a new branch called **week-09-A NAME THAT MAKES SENSE TO YOU from **week-08-A NAME THAT MAKES SENSE TO YOU**.
...
- Project name: **week-09-A NAME THAT MAKES SENSE TO YOU
- Framework: **React**
...
```bash
cd week-09-<A NAME THAT MAKES SENSE TO YOU>
```
