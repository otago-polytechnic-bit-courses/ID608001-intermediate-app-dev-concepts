...
Open your repository in **Visual Studio Code**. Create a new branch called **week-09-vitest-react-testing-library-cypress**.
...
- Project name: **week-09-vitest-react-testing-library-cypress**
- Framework: **React**
...
```bash
cd week-09-vitest-react-testing-library-cypress
```
