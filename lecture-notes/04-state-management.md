...
![](../../resources/img/04-state-management-api/04-state-management-api-1.jpeg)

The screenshot below is an example the book list and a cart with two books when the **Add to cart** button is clicked twice.

![](../../resources/img/04-state-management-api/04-state-management-api-2.jpeg)
...
![](../../resources/img/04-state-management-api/04-state-management-api-3.jpeg)

The screenshot below is an example of the book list and a cart with three books.

![](../../resources/img/04-state-management-api/04-state-management-api-4.jpeg)
