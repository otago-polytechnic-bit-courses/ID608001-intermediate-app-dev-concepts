...
Open your **id607001-s1-26-GitHub username** repository in **Visual Studio Code**. Create a new branch called **week-02-lambda-functions-functional-programming-design-patterns** from the previous branch.
