...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Create a \textbf{APIView} class or \textbf{api\_view} function which handles the \textbf{GET}, \textbf{POST}, \textbf{PUT} \& \textbf{DELETE} HTTP methods.
			\begin{itemize}
				\item \textbf{Resource:}
			\end{itemize}
		\end{itemize} 
	...
	\begin{itemize}
		...
		\item Create a new quiz tournament. Display the form in a modal. Fields include name, category \& difficulty. Select drop downs are populated with categories \& difficulties.
		\item View quiz tournaments in a table. Fields include name, category, difficulty, start date, end date \& creation date.
		\item Update a quiz tournament. Display the form in a modal. Fields include name, category \& difficulty.
		...
		\end{itemize}
		\item Application deployed to \textbf{Heroku} with \textbf{React Buildpack}.
		\begin{itemize}
