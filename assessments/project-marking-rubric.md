...
| **Idiomatic Use**                             | Effective use of control flow, data structures, in-built functions, and design patterns in an idiomatic manner. | Some instances of non-idiomatic code or inefficient use. | Significant non-idiomatic code affecting efficiency. | Poor use of control flow, data structures, functions or design patterns. |
