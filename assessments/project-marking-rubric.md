...
### Functionality: RESTful API - 15%

| **Criteria**                                             | **10-9**                                                 | **8-7**                                                  | **6-5**                                                  | **4-0**                                                  |
| -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------- |
| **User: User Types and Information**     | Clearly defined two user types (admin and basic) with required information. | Minor inconsistencies or missing details in defining user types. | Significant issues or unclear definition of user types.   | Missing or inadequate definition of user types.            |
...
| **User: Seeding of Users**               | Successful seeding of admin and basic users using scripts and external data sources. | Minor issues or inconsistencies in seeding users.        | Significant issues or omissions in seeding users.          | No seeding of users or critical omissions in the process.   |
...
| **Logging in an Admin and Creating a Quiz** | Successfully implement and pass the Cypress test for logging in an admin and creating a quiz. | Minor issues or gaps in implementing and passing the test for logging in an admin and creating a quiz. | Significant issues or incomplete implementation of the test for logging in an admin and creating a quiz. | No or inadequate implementation of the test for logging in an admin and creating a quiz. |
...
| **Criteria**                                       | **5**                                              | **4**                                               | **3-2**                                               | **1-0**                                               |
| --------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------- | ----------------------------------------------------- |
| **Run RESTful API and Frontend Locally** | Provide clear instructions and scripts that successfully run both the RESTful API and frontend applications locally. | Minor issues or gaps in the provided instructions and scripts for running the RESTful API and frontend applications locally. | Significant issues or incomplete instructions/scripts for running the RESTful API and frontend applications locally. | No or inadequate instructions/scripts for running the RESTful API and frontend applications locally. |
...
| **Seed Admin Users**            | Provide clear instructions and scripts that successfully seed admin users. | Minor issues or gaps in the provided instructions and scripts for seeding admin users. | Significant issues or incomplete instructions/scripts for seeding admin users. | No or inadequate instructions/scripts for seeding admin users. |
...
| **Idiomatic Use**                             | Effective use of control flow, data structures, in-built functions, data fetching and state management design patterns in an idiomatic manner. | Some instances of non-idiomatic code or inefficient use. | Significant non-idiomatic code affecting efficiency. | Poor use of control flow, data structures, functions or design patterns. |
...
**Functionality: RESTful API: [x/15]**
