...
In this \textbf{individual} assessment, you will develop a \textbf{RESTful API} using \textbf{Express}, \textbf{Node.js} and the \textbf{OpenTDB API}, and deploy it as a \textbf{web service} on \textbf{Render}. Your data will be stored in a \textbf{PostgreSQL} database on \textbf{Render}. Also, you will develop a \textbf{frontend application} using \textbf{Next.js}. This application will consume the \textbf{RESTful API} mentioned above. The main purpose of this assessment is not just to build a \textbf{full-stack application}, but rather to demonstrate an ability to decouple your \textbf{RESTful API} from your \textbf{frontend application}. In addition, marks will be allocated for code elegance, documentation and \textbf{Git} usage.
...
\begin{tabular}{|c|c|c|c|}
	...
	\small Project                 & \small 80\%        & \small 21-06-2024 (Friday at 4.59 PM) \small  & \small 1, 2                 \\ \hline
\end{tabular}
...
\item \textbf{RESTful API:}
	\begin{itemize}
		...
		\item Implement \textbf{CORS}, \textbf{rate limiting}, \textbf{caching} and \textbf{compression}
	\end{itemize} 
	...
	\begin{itemize}
		\item \textbf{User:}
		\begin{itemize}
			\item Create a register page that allows a \textbf{basic} user to register.
			\item Create a login page that allows a \textbf{super admin} and \textbf{basic} user to login.
			\item Create user pages that allow:
			\begin{itemize}
		...
		\item \textbf{Quiz:}
		\begin{itemize}
			\item Create quiz pages that allow:
			\begin{itemize}
				\item A \textbf{super admin} user to create and delete a quiz, get all quizzes, get all past quizzes, get all present quizzes, get all future quizzes and get a list of scores. 
				\item A \textbf{basic} user to participate in a quiz only once get all quizzes, get all past quizzes, get all present quizzes, get all future quizzes and get a list of scores.
			\end{itemize}
		\end{itemize}
		\item Create a navigation bar that allows a \textbf{super admin} and \textbf{basic} user to navigate to the pages above.
	...
	\item \textbf{Scripts:}
	\begin{itemize}
		\item Run your \textbf{RESTful API} and \textbf{frontend application} locally.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item How do you run your \textbf{RESTful API} and \textbf{frontend application} locally?
