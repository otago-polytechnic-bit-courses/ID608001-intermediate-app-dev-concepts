...
In this \textbf{individual} assessment, you will develop two applications in two parts. Part 1 is a deployed frontend application using \textbf{Next.js} and the \textbf{Hacker News API}. Part 2 is a deployed \textbf{RESTful API} using \textbf{Express} and \textbf{Node.js}.
