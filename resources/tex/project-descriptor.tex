...
\item \textbf{RESTful API:}
	...
	Create a new application using \textbf{Create Vite App}. In this application:
	\begin{itemize}
		\item \textbf{User:}
		\begin{itemize}
	...
	Create a new application using \textbf{Create Vite App}. In this application:
	\begin{itemize}
		\item Create a page that allows an \textbf{unauthenticated} user to get \textbf{RESTful API} information regarding the following:
		\begin{itemize}
		...
		\begin{itemize}
			\item Name of the endpoint. For example, \textbf{Register User}.
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Logging in as an \textbf{admin} user and creating a quiz.
			\item Logging in as a \textbf{basic} user and participating in a quiz.
		\end{itemize}
	\end{itemize}
