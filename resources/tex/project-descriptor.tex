...
\subsection*{Milestone One - Due Friday, 13 September 2024 (Week 8) at 4.59 PM.}
\begin{itemize} 
	...
	\end{itemize}
\end{itemize}
	\subsection*{Milestone Two - Due Friday, 18 October 2024 (Week 11) at 4.59 PM.}
	\begin{itemize}
...
\end{itemize}
	...
	\subsection*{Milestone Three - Due Wednesday, 18 November 2024 (Week 15) at 4.59 PM.}
	\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Amount. \textbf{Note:} This is the number of questions to retrieve. The default value is 10.
			\item Category. \textbf{Note:} This is a dropdown list with the following options:
			\begin{itemize}
				\item General Knowledge. This is the default option.
				\item Entertainment: Books
				\item Entertainment: Film
				\item Science: Computers
				\item Sports
				\item Geography
				\item Art
				\item Celebrities
				...
				\item Vehicles
			\end{itemize}
			\item Difficulty. \textbf{Note:} This is a dropdown list with the following options:
			\begin{itemize}
				\item Easy. This is the default option.
				\item Medium
				\item Hard
			\end{itemize}
			\item Type. \textbf{Note:} This is a dropdown list with the following options:
			\begin{itemize}
				\item Multiple Choice. This is the default option.
				\item True/False
			\end{itemize}
		\end{itemize}
		\item When the form is submitted, perform a request to the \textbf{OpenTDB API}. 
