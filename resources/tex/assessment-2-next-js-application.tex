...
In this \textbf{individual} assessment, you will replicate the given application hosted on \textbf{Heroku} using \textbf{Next.js}. The main purpose of this assessment is to demonstrate your ability to replicate an existing application using various taught frontend concepts. However, you will be required to independently research \& implement more complex concepts. In addition, marks will be allocated for code elegance, documentation \& \textbf{Git} usage.
...
Link to application - \href{}{}
\begin{itemize}
	\item \textbf{Header:}
	\begin{itemize}
		\item The \textbf{Header} component will render six icon components using the \textbf{@material-ui/icons} dependency. The components are:
		\begin{itemize}
			\item Home
			\item FlashOn
			\item LiveTv
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Under the \textbf{img} element, render the movie's overview using the \textbf{react-text-truncate} dependency. 
		...
		\end{itemize}
		\item For styling, the \textbf{MovieCard} component uses \textbf{react-jss}.
...
\begin{itemize}
	...
	\begin{itemize}
		\item How do you setup the development environment, i.e., after the repository is cloned, what do you need to do before you run the \textbf{Next.js} application?
