...
You will complete majority of this assessment during your learner-managed time. However, there will be time during class to discuss the requirements and your progress on this assessment. This assessment will need to be completed by \textbf{Monday, 13 November 2023 at 4.59 PM}.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Five \textbf{super admin} users are seeded via an automation script. Only this automation script can seed the \textbf{super admin} users via a \textbf{npm} script. The \textbf{super admin} users' data will be fetched from a local file and inserted into the \textbf{User} table using \textbf{Prisma}.  
	...
	\begin{itemize}
		...
		\item A \textbf{super admin} and \textbf{basic} user can get all quizzes, get all past quizzes, get all present quizzes, get all future quizzes and get a list of scores . A \textbf{super admin} user can create and delete a quiz. A \textbf{basic} user can participate in a quiz and rate a quiz.
