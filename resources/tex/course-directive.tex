...
\begin{tabular}{ll}
	...
	Timetable:    & Rōpū Kōwhai: Monday 8.00 AM and Thursday 10.00 AM D206 \\ 
\end{tabular} 
...
\begin{tabular}{|c|c|c|}
	...
	4/Whā            & \multicolumn{2}{c|}{React Query}                               \\ \hline
	5/Rima           & \multicolumn{2}{c|}{Tailwind CSS and Shadcn UI}                                                \\ \hline
	6/Ono            & \multicolumn{2}{c|}{Vitest, React Testing Library and Cypress}                                                   \\ \hline
	7/Whitu          &  \multicolumn{2}{c|}{Storybook and GitHub Actions}                            \\ \hline
