...
\begin{itemize}
	...
	\end{itemize}
	\item When an option is selected, display the title of the first 100 stories.
	\item 
\end{itemize}
...
\begin{itemize}
	...
	\item File header comment for each component \& page file explaining its purpose using \textbf{JSDoc}.
