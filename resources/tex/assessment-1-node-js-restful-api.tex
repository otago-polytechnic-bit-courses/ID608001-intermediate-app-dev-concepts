...
\subsection*{Code Elegance - Learning Outcome 1 (25\%)}
\begin{itemize}
	...
	\item \textbf{Mocha}, \textbf{Chai}, \textbf{ESlint}, \textbf{Prettier} and \textbf{Husky} are install as \textbf{development dependencies}.
	\item NPM scripts for the following:
	\begin{itemize}
