...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Two \textbf{super admin} users are seeded via you. Only you can seed the two \textbf{super admin} users. The \textbf{super admin} users' data will be fetched from a local file \& inserted into the \textbf{User} table using \textbf{Prisma}. 
